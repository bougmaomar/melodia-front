...
const ProfileTabs = () => {
  ...
  let selectedTab = 0;
  switch (pathname) {
    case '/artist/profile/personal':
      selectedTab = 1;
      break;
    case '/artist/profile/password':
      selectedTab = 2;
      break;
    case '/artist/profile/basic':
    default:
      selectedTab = 0;
  }
