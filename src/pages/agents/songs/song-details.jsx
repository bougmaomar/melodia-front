              ...
              <Grid item container xs={12} sm={6} md={8}>
                ...
                <Grid item xs={6} md={4}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '13px' }}>
                    <Grid></Grid>
                    <Button variant="outlined" color="primary" startIcon={<Add />} onClick={() => history(`/agent/songs/add-song/${0}`)}>
                    ...
                    <Button
                      ...
                      color="warning"
                      startIcon={<Update />}
                      onClick={() => history(`/agent/songs/update-song/${id}`)}
                    >
                ...
                <Grid item xs={12}>
                  <Box sx={{ mt: 2, width: '100%' }}>
                    <AudioPlayer
                      ...
                      onDownload={() => handleDownloadSong(song.mp3FilePath, 'Agent', () => {}, song.id, user.userId)}
                      onPlay={() => {}}
                    />
                  </Box>
                </Grid>
